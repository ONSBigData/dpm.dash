---
name: dpm.dashboard bug report
about: Template for dpm.dashboard bug reporting
labels: bug
---
...
## Package version/s (if behaviour occurs across multiple dpm.dashboard versions?)
[dpm.dashboard versions affected] 

## Output of sessionInfo()
[Copy the output of running sessionInfo() in the Console]
